 ...
 * temperature in Fahrenheit and the temperature scale are valid, 
 * the program converts the temperature in Fahrenheit to the 
 * specified temperature scale and displays the converted value.
 * 
